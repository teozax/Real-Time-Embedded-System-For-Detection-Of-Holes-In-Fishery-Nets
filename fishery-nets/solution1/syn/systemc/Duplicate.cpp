...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_11_reg_109, "t_V_11_reg_109");
...
void Duplicate::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        t_V_11_reg_109 = j_V_fu_144_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1557_fu_128_p2.read()))) {
...
void Duplicate::thread_cols_V_fu_124_p1() {
...
void Duplicate::thread_i_V_fu_133_p2() {
...
void Duplicate::thread_icmp_ln1557_fu_128_p2() {
...
void Duplicate::thread_icmp_ln1558_fu_139_p2() {
    icmp_ln1558_fu_139_p2 = (!t_V_11_reg_109.read().is_01() || !cols_V_reg_155.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_11_reg_109.read() == cols_V_reg_155.read());
}
...
void Duplicate::thread_j_V_fu_144_p2() {
    j_V_fu_144_p2 = (!t_V_11_reg_109.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(t_V_11_reg_109.read()) + sc_biguint<32>(ap_const_lv32_1));
}
...
void Duplicate::thread_rows_V_fu_120_p1() {
