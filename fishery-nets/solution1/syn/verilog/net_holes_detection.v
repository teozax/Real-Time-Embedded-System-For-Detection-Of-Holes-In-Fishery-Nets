...
(* CORE_GENERATION_INFO="net_holes_detection,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.372281,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=1110,HLS_SYN_DSP=32,HLS_SYN_FF=144330,HLS_SYN_LUT=175303,HLS_VERSION=2019_1}" *)
...
wire    ap_done;
wire    ap_idle;
wire    Block_codeRepl7833_p_U0_ap_start;
wire    Block_codeRepl7833_p_U0_start_full_n;
wire    Block_codeRepl7833_p_U0_ap_done;
wire    Block_codeRepl7833_p_U0_ap_continue;
wire    Block_codeRepl7833_p_U0_ap_idle;
wire    Block_codeRepl7833_p_U0_ap_ready;
wire    Block_codeRepl7833_p_U0_start_out;
wire    Block_codeRepl7833_p_U0_start_write;
wire   [9:0] Block_codeRepl7833_p_U0_I_enhanced_rows_V_out_din;
wire    Block_codeRepl7833_p_U0_I_enhanced_rows_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_I_enhanced_cols_V_out_din;
wire    Block_codeRepl7833_p_U0_I_enhanced_cols_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_img_2_rows_V_out_din;
wire    Block_codeRepl7833_p_U0_img_2_rows_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_img_2_cols_V_out_din;
wire    Block_codeRepl7833_p_U0_img_2_cols_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_img_3_rows_V_out_din;
wire    Block_codeRepl7833_p_U0_img_3_rows_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_img_3_cols_V_out_din;
wire    Block_codeRepl7833_p_U0_img_3_cols_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_img_4_rows_V_out_din;
wire    Block_codeRepl7833_p_U0_img_4_rows_V_out_write;
wire   [9:0] Block_codeRepl7833_p_U0_img_4_cols_V_out_din;
wire    Block_codeRepl7833_p_U0_img_4_cols_V_out_write;
...
wire    img_2_rows_V_c7940_full_n;
wire   [9:0] img_2_rows_V_c7940_dout;
wire    img_2_rows_V_c7940_empty_n;
wire    img_2_cols_V_c7941_full_n;
wire   [9:0] img_2_cols_V_c7941_dout;
wire    img_2_cols_V_c7941_empty_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_Block_codeRepl7833_p_U0_ap_ready;
wire    ap_sync_Block_codeRepl7833_p_U0_ap_ready;
reg   [1:0] Block_codeRepl7833_p_U0_ap_ready_count;
...
initial begin
#0 ap_sync_reg_Block_codeRepl7833_p_U0_ap_ready = 1'b0;
#0 Block_codeRepl7833_p_U0_ap_ready_count = 2'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_codeRepl7833_p_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Block_codeRepl7833_p_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Block_codeRepl7833_p_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Block_codeRepl7833_p_U0_ap_ready_count <= (Block_codeRepl7833_p_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (1'b1 == Block_codeRepl7833_p_U0_ap_ready))) begin
        Block_codeRepl7833_p_U0_ap_ready_count <= (Block_codeRepl7833_p_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_codeRepl7833_p_U0_ap_continue = 1'b1;

assign Block_codeRepl7833_p_U0_ap_start = ((ap_sync_reg_Block_codeRepl7833_p_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_codeRepl7833_p_U0_start_full_n = (start_for_Duplicate_U0_full_n & start_for_Duplicate270_U0_full_n & start_for_Duplicate266_U0_full_n & start_for_AddWeighted_U0_full_n);
...
assign ap_idle = (threshold_U0_ap_idle & mean_filter_2D_U0_ap_idle & mat2gray_U0_ap_idle & ex_enhancement_U0_ap_idle & ccl_U0_ap_idle & adaptive_threshold_U0_ap_idle & MinMaxLoc_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Loop_loop_height_pro_U0_ap_idle & Loop_loop_height_pro_1_U0_ap_idle & Duplicate_U0_ap_idle & Duplicate270_U0_ap_idle & Duplicate269_U0_ap_idle & Duplicate266_U0_ap_idle & Block_codeRepl7833_p_U0_ap_idle & AddWeighted_U0_ap_idle & AXIvideo2Mat_U0_ap_idle & AXIstream2Mat_U0_ap_idle);
...
assign ap_sync_Block_codeRepl7833_p_U0_ap_ready = (ap_sync_reg_Block_codeRepl7833_p_U0_ap_ready | Block_codeRepl7833_p_U0_ap_ready);

assign ap_sync_continue = 1'b1;

assign ap_sync_done = Mat2AXIvideo_U0_ap_done;

assign ap_sync_ready = (ap_sync_Block_codeRepl7833_p_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);
